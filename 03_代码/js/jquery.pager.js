(function($) {     
    ...
    function renderpager(pagenumber, pagecount,pagetotal,buttonClickCallback) {           
        ...
        var strgoto = $("<li class='thpoint'>当前<input type='text' value='"+pagenumber+"'maxlength='6' id='gotoval' style='width:30px; margin-top:0px;padding-top:2px;padding-left:10px;'/>页</li>");  
